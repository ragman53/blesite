...
| **Viewer** | Sandboxed WebView | `javascriptEnabled: false`, `blockNetworkLoads: true`。セキュリティと描画再現性の両立。 |
...
| `1-6` | `SiteID` | 6B | `SHA256(host_pubkey + timestamp_ms)[0..6]` |
| `7-8` | `CategoryCode` | 2B | `0x0001`=Food, `0x0002`=Art, `0x0003`=Event, `0x0004`=Info |
| `9-12` | `PubKeyHint` | 4B | `host_pubkey[0..4]` — relay/redetect authenticity check用 |
| `13` | `Vitality` | 1B | upper 4bit: vitality 0–15 (scaled from f32), lower 4bit: reserved |
| `14` | `Flags` | 1B | bit0=`is_relay`, bit1=`has_update`, bit2-7=reserved |
| `15` | `Checksum` | 1B | CRC8 of bytes 0–14 |
...
pub const CHUNK_SIZE_DEFAULT: usize = 480;    // MTU512 - ATT(3) - GATT(29) ≈ 480
pub const CHUNK_SIZE_FALLBACK: usize = 17;    // MTU20 - ATT(3)
pub const MAX_CHUNKS: usize = MAX_TOTAL_SIZE / CHUNK_SIZE_DEFAULT + 1; // 27
...
- [ ] Pass-by 15km/h at 10m closest: success rate ≥ 9/10
